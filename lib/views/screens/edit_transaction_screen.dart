    ...
    Get.defaultDialog(
      ...
      content: SizedBox(
        ...
        child: ListView.builder(
          itemCount: isCategories ? _addCategoryController.myCategories.length : _addCategoryController.myPaymentMode.length,
          itemBuilder: (context, i) {
            final data = isCategories ? _addCategoryController.myCategories[i].type! : _addCategoryController.myCategories[i].type!;
            return ListTile(
              onTap: () {
                isCategories
