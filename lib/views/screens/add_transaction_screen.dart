                    ...
                    child: InputField(
                      hint:
                          _addTransactionController.selectedCategory.isNotEmpty
                              ...
                              : _addCategoryController.myCategories[0].type!,
                      label: 'Category',
                      widget: IconButton(
                  ...
                  IconButton(
                      onPressed: () {
                        Get.to(() => AddCategoriesScreen(
                            title: ADD_CATEGORY, isBack: true));
                      },
                      icon: Icon(Icons.add))
                ],
              ),
              Row(
                children: [
                  Expanded(
                    child: InputField(
                      hint: _addTransactionController.selectedMode.isNotEmpty
                          ...
                          : _addCategoryController.myPaymentMode[0].type!,
                      isAmount: true,
                      label: 'Payment Mode',
                      widget: IconButton(
                  ...
                  IconButton(
                      onPressed: () {
                        Get.to(() =>
                            AddCategoriesScreen(title: ADD_MODE, isBack: true));
                      },
                      icon: Icon(Icons.add))
                ],
              )
